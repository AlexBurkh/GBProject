...
class Bot():
    ...
    async def print_book(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        answer = self._Control.load_print_book()
        await update.message.reply_text(answer)

    async def add_contact(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    async def delete_contact(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    def run(self):
        ...
        self.__app.add_handler(CommandHandler("add_contact", self.add_contact))
        self.__app.add_handler(CommandHandler("print_book", self.print_book))
        self.__app.add_handler(CommandHandler("delete_contact", self.delete_contact))
